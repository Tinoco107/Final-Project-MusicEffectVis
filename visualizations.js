function updateResponseDistributions() {
    ...
    subjects.forEach(s => {
      ...
      const width = 250, height = 150, marginHist = { top: 20, right: 20, bottom: 30, left: 30 };
